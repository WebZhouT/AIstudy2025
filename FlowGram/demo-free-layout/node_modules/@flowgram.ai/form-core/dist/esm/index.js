...
// src/error/renders/error-render.tsx
var ErrorRender = ({ node, playgroundContext, clientContext }) => {
...
import { PlaygroundContext as PlaygroundContext4, useRefresh as useRefresh5, useService as useService3, PluginContext as PluginContext2 } from "@flowgram.ai/core";
...
var PureNodeRender = ({ node }) => {
  ...
  const clientContext = useService3(PluginContext2);
