<template>
  <div class="tabs">
    <el-scrollbar class="scroll-container tags-view-container"
                  ...
                  @scroll="handleScroll">
      <Item v-for="menu in menuList"
            :key="menu.meta.title" :menu="menu"
            :active="activeMenu.path === menu.path"
            @close="delMenu(menu)"
            @reload="pageReload" />
    </el-scrollbar>
    <div class="handle">
      <div id="vueAdminBoxTabRefresh"
           @click="pageReload"></div>
      <div id="vueAdminBoxTabCloseSelf"
           @click="closeCurrentRoute"></div>
      <div id="vueAdminBoxTabCloseOther"
           @click="closeOtherRoute"></div>
      <div id="vueAdminBoxTabCloseAll"
           @click="closeAllRoute"></div>
      <el-dropdown placement="bottom">
        ...
        <template #dropdown>
          <el-dropdown-menu>
            <el-dropdown-item class="tab-ddropdown-item"
                              :icon="RefreshLeft"
                              @click="pageReload">重新加载</el-dropdown-item>
            <el-dropdown-item class="tab-ddropdown-item"
                              :icon="CircleClose"
