  ...
  <header>
    <div class="left-box">
      ...
      <div class="menu-icon"
        ...
        <i class="sfont head-fold"
           :class="isCollapse ? 'system-s-unfold' : 'system-s-fold'"></i>
      </div>
      <Breadcrumb />
    </div>
    <div class="right-box">
      ...
      <div class="function-list">
        <div
             class="function-list-item hidden-sm-and-down">
          <Full-screen />
        </div>
      ...
      <div class="user-info">
        <el-dropdown>
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <!-- <el-dropdown-item
                                @click="showPasswordLayer">修改密码</el-dropdown-item> -->
              <el-dropdown-item
                                @click="loginOut">退出登录</el-dropdown-item>
            </el-dropdown-menu>
          </template>
        </el-dropdown>
      </div>
      <password-layer :layer="layer"
                      v-if="layer.show" />
    </div>
  </header>
</template>
